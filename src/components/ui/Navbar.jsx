...
export default function Navbar({ children}) {
  return (
<nav className="block w-full max-w-screen-lg px-4 py-2 mx-auto  sticky top-3 shadow lg:px-8 lg:py-3 backdrop-blur-lg backdrop-saturate-150 z-[9999] text-foreground dark:text-sidebar-dark-accent">
